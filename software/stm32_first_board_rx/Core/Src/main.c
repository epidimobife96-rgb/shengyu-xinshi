...
/**
  ******************************************************************************
  * @file           : main.c
  * @brief          : First board 4-FSK receiver test.
  ******************************************************************************
  */
...
static void MX_TIM5_PWM_Init(void);
...
static void TX_Stop(void)
{
  ...
  tx_done_pending = 0U;
  tx_done_is_calibration = 0U;
  __HAL_TIM_SET_COMPARE(&htim5, TIM_CHANNEL_1, TX_PWM_MID);
  __enable_irq();
...
static void TX_AudioTick(void)
{
  ...
  if (tx_mode == TX_MODE_CALIBRATION)
  {
    ...
    {
      __HAL_TIM_SET_COMPARE(&htim5, TIM_CHANNEL_1, TX_ScaledSineSample());
...
int main(void)
{
  ...
  printf("\r\nFirst board 4-FSK RX/TX start\r\n");
  printf("HALF DUPLEX: RX PC4, TX PA0, *=RX/TX, POWER SW2 PB9, HOLD PC1\r\n");
...
static void MX_TIM5_PWM_Init(void)
{
  ...
  htim5.Init.Period = TX_PWM_PERIOD;
